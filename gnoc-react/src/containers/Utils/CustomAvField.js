...
var _CustomAvInput = require('./CustomAvInput');

var _CustomAvInput2 = _interopRequireDefault(_CustomAvInput);

var _AvGroup = require('availity-reactstrap-validation/lib/AvGroup');

var _AvGroup2 = _interopRequireDefault(_AvGroup);

var _AvFeedback = require('availity-reactstrap-validation/lib/AvFeedback');
...
var CustomAvField = function (_Component) {
  (0, _inherits3.default)(CustomAvField, _Component);

  function CustomAvField() {
    (0, _classCallCheck3.default)(this, CustomAvField);
    return (0, _possibleConstructorReturn3.default)(this, _Component.apply(this, arguments));
  }

  CustomAvField.prototype.getChildContext = function getChildContext() {
    var _this2 = this;
  ...
  CustomAvField.prototype.render = function render() {
    var row = false;
    var col = {};
    var labelCol = {};
    ...
    var renderRequired = _react2.default.createElement(
      "span",
      null,
      " ",
      _react2.default.createElement(
        _reactstrap.Label,
        {style: {color: 'rgb(248, 108, 107)'}},
        "(*)"
      )
    );
    ...
    return _react2.default.createElement(
      ...
      input.props.required && !(this.props.isinputonly === "true" ? true : false) && renderRequired,
      !check && inputRow,
      !row && feedback,
      !row && help
    );
  ...
  return CustomAvField;
}(_react.Component);

CustomAvField.propTypes = (0, _assign2.default)({}, _CustomAvInput2.default.propTypes, {
  ...
  isinputonly: _propTypes2.default.string
});
CustomAvField.contextTypes = {
  FormCtrl: _propTypes2.default.object.isRequired
};
CustomAvField.childContextTypes = {
  FormCtrl: _propTypes2.default.object.isRequired
};
exports.default = CustomAvField;