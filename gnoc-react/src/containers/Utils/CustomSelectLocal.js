...
class CustomSelectLocal extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        if (this.props.selectValue.constructor === Object) {
            if (this.isEmptyObject(this.props.selectValue)) {
                ...
                if(defaultValue.value !== null && options.some(item => item.itemId + "" === defaultValue.value + "")) {
...
export default translate()(CustomSelectLocal);