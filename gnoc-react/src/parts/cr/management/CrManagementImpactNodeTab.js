...
class CrManagementImpactNodeTab extends Component {
    constructor(props) {
        super(props);
    ...
    getLisNodeOfCR = () => {
        ...
        this.props.actions.getLisNodeOfCR(objectSearch).then((response) => {
            ...
            toastr.error(this.props.t("crManagement:crManagement.message.error.getImpactNode"));
        });
    }
                ...
                <Card>
                    <CardHeader>
                        <div style={{position: 'absolute'}} className="mt-1">
                            <i className="fa fa-align-justify mr-2"></i>{t("crManagement:crManagement.title.impactNodeList")}
                        </div>
                        {
                            this.props.parentState.visibleToolbarTab.networkNode.all ?
                            <div className="card-header-actions card-header-search-actions-button">
                                <Button type="button" size="md" color="primary" className={this.props.parentState.visibleToolbarTab.networkNode.import ? "custom-btn btn-pill mr-2" : "class-hidden"}
                                ...
                                <LaddaButton type="button"
                                    className={this.props.parentState.visibleToolbarTab.networkNode.export ? "btn btn-primary btn-md custom-btn btn-pill mr-2" : "class-hidden"}
                                ...
                                <Button type="button" size="md" color="primary" className={this.props.parentState.visibleToolbarTab.networkNode.add ? "custom-btn btn-pill mr-2" : "class-hidden"}
                                    title={t("crManagement:crManagement.button.add")}
                                    onClick={this.openNetworkNodePopup}><i className="fa fa-plus"></i></Button>
                                <Button type="button" size="md" color="primary" className={this.props.parentState.visibleToolbarTab.networkNode.delete ? "custom-btn btn-pill mr-2" : "class-hidden"}
...
CrManagementImpactNodeTab.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(translate()(CrManagementImpactNodeTab));