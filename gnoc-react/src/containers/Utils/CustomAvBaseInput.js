...
var CustomAvBaseInput = function (_Component) {
  (0, _inherits3.default)(CustomAvBaseInput, _Component);

  function CustomAvBaseInput(props) {
    (0, _classCallCheck3.default)(this, CustomAvBaseInput);
  ...
  CustomAvBaseInput.prototype.componentWillMount = function componentWillMount() {
    this.value = this.props.value || this.getDefaultValue();
    this.setState({ value: this.value });
    this.updateValidations();
  };

  CustomAvBaseInput.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
  ...
  CustomAvBaseInput.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    if (prevProps.name !== this.props.name) {
      this.context.FormCtrl.register(this);
    }
  };

  CustomAvBaseInput.prototype.componentWillUnmount = function componentWillUnmount() {
    this.context.FormCtrl.unregister(this);
  };

  CustomAvBaseInput.prototype.onKeyUpHandler = function onKeyUpHandler(event) {
  ...
  CustomAvBaseInput.prototype.onInputHandler = function onInputHandler(_value) {
  ...
  CustomAvBaseInput.prototype.onBlurHandler = function onBlurHandler(_value) {
    this.value = this.getFieldValue(_value);
  ...
  CustomAvBaseInput.prototype.onFocusHandler = function onFocusHandler(_value) {
    this.value = this.getFieldValue(_value);
  ...
  CustomAvBaseInput.prototype.onChangeHandler = function onChangeHandler(_value) {
    this.value = this.getFieldValue(_value);
    this.validateEvent('onChange', _value);
    !this.context.FormCtrl.isDirty(this.props.name) && this.context.FormCtrl.setDirty(this.props.name);
  };

  CustomAvBaseInput.prototype.getDefaultValue = function getDefaultValue() {
    var defaultValue = '';
  ...
  CustomAvBaseInput.prototype.getFieldValue = function getFieldValue(event) {
    if (this.props.type === 'checkbox') {
  ...
  CustomAvBaseInput.prototype.getValidationEvent = function getValidationEvent() {
  ...
  CustomAvBaseInput.prototype.getValidatorProps = function getValidatorProps() {
    var _this2 = this;
  ...
  CustomAvBaseInput.prototype.getValue = function getValue() {
    return this.value;
  };

  CustomAvBaseInput.prototype.reset = function reset() {
  ...
  CustomAvBaseInput.prototype.validateEvent = function validateEvent(eventName, _event) {
    this.setState({ value: this.value });
  ...
  CustomAvBaseInput.prototype.validate = function validate() {
    this.context.FormCtrl.validate(this.props.name);
  };

  CustomAvBaseInput.prototype.updateValidations = function updateValidations() {
    var _this3 = this;
  ...
  return CustomAvBaseInput;
}(_react.Component);

CustomAvBaseInput.propTypes = {
...
CustomAvBaseInput.contextTypes = {
  FormCtrl: _propTypes2.default.object.isRequired
};
CustomAvBaseInput.defaultProps = {
  validationEvent: '',
  validate: {},
  trueValue: true,
  falseValue: false
};
exports.default = CustomAvBaseInput;